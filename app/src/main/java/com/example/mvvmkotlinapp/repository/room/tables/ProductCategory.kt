...
data class ProductCategory(@PrimaryKey(autoGenerate = true) @ColumnInfo(name = "prod_cat_id") var prod_cat_id: Int?,
                      @ColumnInfo(name = "prod_cat_name") var prod_cat_name: String? =null,
    ...
    constructor() : this(0, prod_cat_name=null,route_id=0,outlet_id=0,dist_id=0, status = null)
}