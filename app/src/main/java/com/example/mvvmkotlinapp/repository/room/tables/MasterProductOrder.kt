...
data class MasterProductOrder(@PrimaryKey(autoGenerate = true) val uid: Int,
    ...
    @ColumnInfo(name = "order_delivered_quantity") var order_delivered_quantity: Int? =0,
    @ColumnInfo(name = "order_total_delivered_price") var order_total_delivered_price: Double? =0.0) : Serializable {
    ...
    constructor() : this(0,cart_ids=null,route_id=0,outlet_id=0,dist_id=0, order_total_price = 0.0,
        ...
        order_remark=null,offer_id=0,offer_amount=0.0,order_delivered_quantity=0,order_total_delivered_price=0.0)
}