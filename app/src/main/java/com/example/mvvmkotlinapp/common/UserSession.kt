...
class UserSession {
    ...
    val KEY_CHATWITH_USER = "chatWithUser"
    val KEY_IMEI = "imei"
    ...
    fun setChatWithUser(username: String?) {
        editor!!.putString(KEY_CHATWITH_USER, username)
        editor!!.commit()
    }

    fun getChatWithUser(): String? {
        return pref!!.getString(KEY_CHATWITH_USER, null)
    }
