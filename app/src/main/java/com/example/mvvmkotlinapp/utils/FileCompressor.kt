...
class FileCompressor {
    ...
    private var imageCameraCompress: ImageCameraCompress? = ImageCameraCompress()
    ...
    fun FileCompressor(context: Context) {
    ...
    fun compressToFile(imageFile: File, compressedFileName: String): File? {
        return imageCameraCompress?.compressImage(
            imageFile,
            maxWidth,
            maxHeight,
            compressFormat,
    ...
    fun compressToBitmap(imageFile: File): Bitmap? {
        return imageCameraCompress?.decodeSampledBitmapFromFile(imageFile, maxWidth, maxHeight)
    }
