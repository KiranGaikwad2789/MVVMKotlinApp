...
import kotlinx.android.synthetic.main.prograss_bar_dialog.view.*


class SkyggeProgressDialog {

    lateinit var dialog: SkyggeProgressDialog
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        dialog = SkyggeProgressDialog(context)
    ...
    class SkyggeProgressDialog(context: Context) : Dialog(context, R.style.CustomDialogTheme) {
        init {
            // Set Semi-Transparent Color for Dialog Background
            window?.decorView?.rootView?.setBackgroundResource(R.color.colorPrimary3)
